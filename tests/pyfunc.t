...
foo:.p.callable .p.get`foo
goo:.p.callable .p.get`goo
hoo:.p.callable .p.get`hoo
til[4]~foo[0;1;2;3]
til[4]~foo . til 4
...
1b~.[foo;(`a pykw 0;1;2;3);{"positional argument follows keyword argument"~x}]
1b~.[foo;(`a pykw 0;pyarglist 1 2 3);{"positional argument follows keyword argument"~x}]
1b~.[foo;(`a pykw 0;1 2 3);{"positional argument follows keyword argument"~x}]
-1"## q calls python end";
